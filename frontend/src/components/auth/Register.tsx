  ...
  return(
    <Auth>
      <div className="flex justify-center items-center flex-col">
        ...
        <form>
        <input type="text" name="nick" value={userData.nick} onChange={changeInputValue} placeholder="Enter your Nick" className="authInput textIndent" />
          ...
          <div className="flex items-center">
            <input type={showPasswordTwo ? "text" : "password"} name="passwordTwo" value={userData.passwordTwo} onChange={changeInputValue} placeholder="Repeat Password" className="authInput textIndent" />
